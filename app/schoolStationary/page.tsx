...
export default function SchoolStationaryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      setError(null);
      try {
        const res = await fetch("/api/products?category=School Stationary");
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-700">
              Everything you need for school — quality stationery at great prices
            </p>
          </div>
              ...
              {products.map((p) => {
                ...
                return (
                  ...
                  >
                    {/* BADGE */}
                    {p.badge && (
                      <span className="self-start mb-2 text-xs font-bold px-2 py-1 bg-amber-100 text-amber-700 rounded-full">
                        {p.badge}
                      </span>
                    )}
